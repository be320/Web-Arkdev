...
?>
    ...
    <<div class="main">
        ...
        <div class="slideshow-container">
            ...
            <a class="prev" style="display: block; margin-left: auto; margin-left: 0;" onclick="plusSlides(-1)">&#10094;</a>
            <a class="next" style="display: block; margin-left: auto; margin-right: 0;" onclick="plusSlides(1)">&#10095;</a>
